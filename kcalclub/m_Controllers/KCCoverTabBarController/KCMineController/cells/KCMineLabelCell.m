...
@implementation KCMineLabelCell
...
- (UIImageView *)arrowImageView{
    if (!_arrowImageView) {
        ...
        [self.contentView addConstraint:[NSLayoutConstraint constraintWithItem:imgv attribute:NSLayoutAttributeCenterY relatedBy:NSLayoutRelationEqual toItem:_titleLabel attribute:NSLayoutAttributeCenterY multiplier:1 constant:0.f]];
