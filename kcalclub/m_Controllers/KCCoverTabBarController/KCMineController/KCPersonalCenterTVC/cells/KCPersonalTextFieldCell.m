...
@interface KCPersonalTextFieldCell()
...
@implementation KCPersonalTextFieldCell
...
- (UITextField *)textfield{
    if (!_textfield) {
        ...
        textfield.text = @"未输入内容";
        textfield.font = [UIFont systemFontOfSize:18.0f];
        textfield.textColor = RGBHexColor(0x333333, 1);
        textfield.textAlignment = NSTextAlignmentRight;
//        textfield.backgroundColor = RGB_R;
        
        textfield.translatesAutoresizingMaskIntoConstraints = NO;
        [self.contentView addConstraint:[NSLayoutConstraint constraintWithItem:textfield attribute:NSLayoutAttributeRight relatedBy:NSLayoutRelationEqual toItem:self.contentView attribute:NSLayoutAttributeRight multiplier:1 constant:-40.f]];
        [self.contentView addConstraint:[NSLayoutConstraint constraintWithItem:textfield attribute:NSLayoutAttributeTop relatedBy:NSLayoutRelationEqual toItem:self.contentView attribute:NSLayoutAttributeTop multiplier:1 constant:0.f]];
        [self.contentView addConstraint:[NSLayoutConstraint constraintWithItem:textfield attribute:NSLayoutAttributeBottom relatedBy:NSLayoutRelationEqual toItem:self.contentView attribute:NSLayoutAttributeBottom multiplier:1 constant:-0.f]];
        [self.contentView addConstraint:[NSLayoutConstraint constraintWithItem:textfield attribute:NSLayoutAttributeWidth relatedBy:NSLayoutRelationEqual toItem:nil attribute:NSLayoutAttributeWidth multiplier:1 constant:200]];
